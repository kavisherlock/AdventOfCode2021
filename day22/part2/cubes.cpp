...
const int REGION_EDGE_DISTANCE = 100;
...
void setCubeValues(bool (&cubes)[DIMENSION][DIMENSION][DIMENSION], const vector<pair<int, int>> &ranges, bool value) {
...
int main () {
  ...
  bool cubes[DIMENSION][DIMENSION][DIMENSION];
  ...
  for (string line : lines) {
    ...
    setCubeValues(cubes, ranges, turnOn);
  }
