...
current_snailfish = string_to_list(contents[0].strip())
for i in range(1, len(contents)):
  next_snailfish = string_to_list(contents[i].strip())
  current_snailfish = reduce_snailfish(add_snailfish(current_snailfish, next_snailfish))
print(''.join(map(str, current_snailfish)))
print(get_magnitude(''.join(map(str, current_snailfish))))
